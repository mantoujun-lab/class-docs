---
title: 课程笔记
description: 25 级计算机应用 1 班各学科课程知识点整理,涵盖 Python pandas 题型总结、计算机基础、Office 办公、图像处理、网络基础与编程入门。
keywords: 课程笔记,计算机应用,学科知识,Python pandas 题型总结,计算机基础,Office,编程基础,海南省经济技术学校
---
...
| 学科 | 计划收录内容 |
| --- | --- |
| 计算机基础 | 操作系统、硬件组成、文件管理与常用概念 |
| Office 办公 | Word 文字处理、Excel 表格、PowerPoint 演示文稿 |
| 图像处理 | Photoshop 常用工具与实操案例 |
| 网络基础 | 网络组成、协议与互联网常识 |
| 编程入门 | HTML / CSS / JavaScript 前端基础 |
